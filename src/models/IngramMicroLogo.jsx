...
Command: npx gltfjsx@6.2.16 IngramMicroLogo.gltf 
*/
...
export default function Model(props) {
  const { nodes, materials } = useGLTF('/models/IngramLogo/IngramMicroLogo.gltf')
  ...
  return (
    <group {...props} dispose={null} ref={groupRef}>
      <mesh geometry={nodes.IngramMicroLogo.geometry} material={materials['SVGMat.001']} />
...
useGLTF.preload('/models/IngramLogo/IngramMicroLogo.gltf')
